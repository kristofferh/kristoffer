          ...
          <div className="row center">
            <div className="col-xs-12 col-sm-8">
              <p className="load-in">
                ...
                <em>Google</em>, <em>Nintendo</em>, <em>Microsoft</em>, and many
                others.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                <em>USA Today</em>, embedding with the Gannett team in Virginia.
                I also worked on several Google projects, including{" "}
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                range of projects — from fine-arts to digital entertainment. One
                of my first projects was for Microsoft, building out the welcome
                screen for their brand new browser - Internet Explorer 7! (this
                was in 2007).
              </p>
            </section>
          </div>
