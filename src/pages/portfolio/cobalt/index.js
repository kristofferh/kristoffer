          ...
          <section className="content-container">
            ...
            <div className="row center">
              <div className="col-xs-12 col-sm-8">
                <p className="load-in">
                  Cobalt, now apart of ADP, is an agency that caters solely to
                  the automotive industry. I joined a week before GM, Ford, and
                  Chrysler had to be bailed out by the government and the
                  industry was in turmoils.
                </p>
                <p className="load-in">
                  I worked primarily on the BMW and Volkswagen accounts. There
                  were unique design constraints: The brand guideline were
                  fairly strict, there were pre-built and difficult to style
                  internal components, so the challenge was to find a way for
                  dealerships to distinguish themselves from one-another, having
                  flexible options, while staying on brand. All while
                  remembering the end-user - priority number one.
                </p>
              </div>
            </div>
          </section>
