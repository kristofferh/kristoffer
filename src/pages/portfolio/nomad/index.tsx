        ...
        <section className="content-container">
          <div className="row">
            <div className="col-xs-12 col-sm-8 col-sm-offset-2">
              ...
              <p className="load-in">
                Healthcare staffing is a big industry, fraught with all the
                issues that plague the rest of the healthcare system in the
                United States: slow moving bureaucracy, inefficiencies at every
                stage, technology from 1988, confusing and overly complicated.
                It is also way more expensive than it needs to be. Nomad changed
                all that.
              </p>
              <p className="load-in">
                We created a marketplace that is easy and fun to navigate,
                user-friendly, efficient, and most importantly:{" "}
        ...
        <section className="content-container">
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              <h2 className="sub-title load-in">What Did I Do There?</h2>
              <p className="load-in">
                A little bit of everything - just the way I like it.
              </p>
              <p className="load-in">
                I was employee number two (after co-founders) and had a unique
                hybrid role: I was an Art Director and, at the same time, the
                Lead Product Engineer. I spent half of my time designing
                features and systems, and the other half building them. I also
                spent a lot of time hiring and growing the team, building up a
                strong foundation of designers, PMs, and engineers.
              </p>
            </section>
          </div>
        </section>
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                was slightly modified for each project, but it typically
          ...
          <ol className="portfolio-process content-container">
            ...
            <li className="portfolio-process-item">
              ...
              <p>
                ...
                A/B tests, hold-backs, or staggered rollouts.
              </p>
            </li>
            <li className="portfolio-process-item">
