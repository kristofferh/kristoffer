        ...
        <div className="portfolio">
          ...
          <section className="content-container">
            ...
            <div className="row">
              <div className="col-xs-12 col-sm-8">
                ...
                <p className="load-in">
                  It’s a big industry, fraught with all the issues that plague
                  the rest of the healthcare system in the United States: slow
                  moving bureaucracy, inefficiencies galore, technology from
                  1988, and everything is way more expensive than it needs to
                  be. We’re changing all that.
                </p>
                <p className="load-in">
            ...
            <div className="row">
              <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
                ...
                <p className="load-in">
                  ...
                  of my time designing features, and the other half building
                  them.
                </p>
              </section>
            </div>
            ...
            <div className="row">
              <section className="col-xs-12 col-sm-8 portfolio-copy--second-row">
                ...
                <p className="load-in">
                  ...
                  features, others are brand-new greenfield iniatives. The
                  process is therefore slightly modified for each one, but it
                  typically follows the same steps.
                </p>
              </section>
            </div>
          </section>
            ...
            <ol className="portfolio-process content-container">
              ...
              <li className="portfolio-process-item">
                ...
                <p>
                  ...
                  problem, formulate a hypothesis. Distill the goals and
                  outcomes. Sketches, occasionally wireframes, and initial
                  mockups of the overall flow and strategy.
                </p>
              </li>
              <li className="portfolio-process-item">
              ...
              <li className="portfolio-process-item">
                ...
                <p>
                  Incorporate feedback from stakeholders and users. Add polish
                  and explore animations.
                </p>
              </li>
              <li className="portfolio-process-item">
              ...
              <li className="portfolio-process-item">
                ...
                <p>
                  Build the designs. Add a little extra to make it fun. Release
                  as A/B tests or staggered rollouts.
                </p>
              </li>
              <li className="portfolio-process-item">
          ...
          <section className="portfolio-media">
            <div className="row">
              ...
              >
                <DeviceFrame
                  className="load-in load-in--sequence-3"
                  type="phone"
                >
                  <ImageLoader
