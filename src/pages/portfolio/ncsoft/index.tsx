          ...
          <div className="row center">
            <div className="col-xs-12 col-sm-8">
              <p className="load-in">
                ...
                game studios, developing mainly MMO games. My job was to design
                marketing sites and installers.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                heavily inspired by the concept art created specifically for the
                game. We wanted to carry that direction over to the site as
                well, so we used lots of brushes, concept art, and hand-written
                fonts to convey the same sort of painterly quality.
              </p>
            </section>
          </div>
        </section>
          ...
          <div className="row">
            <section className="col-xs-12 col-sm-8 col-sm-offset-2 portfolio-copy--second-row">
              ...
              <p className="load-in">
                ...
                renewed interested in the original, so I redesigned the existing
                site. I wanted to maintain the focus on characters, but make it
                a little more modern and responsive. The original also felt much
                too cramped, so I tried to make the new version a little airier.
              </p>
            </section>
          </div>
        </section>
