            ...
            <div className="row center">
              <div className="col-xs-12 col-sm-8">
                <p className="load-in">
                  ...
                  inspired. This section also includes side-projects and
                  contract work.
                </p>
              </div>
            </div>
          ...
          <section className="content-container">
            <div className="row">
              <section className="col-xs-12 col-sm-8 col-sm-offset-2">
                ...
                <p className="load-in">
                  <em>Spender</em> is a spending tracker. It connects to your
                  bank accounts and lets you manually track cash transactions. I
                  founded the project and am taking it from concept, to design,
                  to development.
                </p>
              </section>
            </div>
            ...
            <div className="row">
              <section className="col-xs-12 col-sm-8 col-sm-offset-2">
                ...
                <p className="load-in">
                  ...
                  lets users get a quick idea of what’s happening at their home
                  or office.
                </p>
                <p className="load-in">
                ...
                <p className="load-in">
                  The goal is to include the most frequent use cases, and give
                  the user an option to open the companion app for a device for
                  more detailed views.
                </p>
              </section>
            </div>
          ...
          <section className="content-container">
            <div className="row">
              <section className="col-xs-12 col-sm-8 col-sm-offset-2">
                ...
                <p className="load-in">
                  A combination of a todo-list and a calendar. A side-project
                  that I work on whenever I have time, which is seldom.
                </p>
              </section>
            </div>
          </section>
