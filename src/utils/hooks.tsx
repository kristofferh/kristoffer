...
export const useScrollData = (options: OptionsType = {}): ScrollDataType => {
  const [data, setData] = useState<ScrollDataType>(INITIAL_DATA);
  const startValues = useRef<ScrollDataType>(INITIAL_DATA);
  const frameValues = useRef<ScrollDataType>(INITIAL_DATA);
